...
namespace TriadServer.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly TriadContext _context;

        public AuthController(IConfiguration configuration, IUserService userService, TriadContext context)
        {
        ...
        public async Task<ActionResult<User>> Register(UserDto request)
        {
            ...
            {
                return BadRequest("Les mots de passe doivent être identiques");
            }
